...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        #TODO ablation study
        self.iterations = 50_000 # [default 30_000] Each iteration corresponds to reconstructing 1 image. The number of points being optimized increases over
        ...
        self.depth_l1_weight_final = 0.0001
